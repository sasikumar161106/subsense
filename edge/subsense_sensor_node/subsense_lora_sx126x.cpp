...
bool subsense_lora_sx126x_init(uint16_t freq_mhz, uint16_t node_addr, bool enable_rssi) {
    ...
    cfg_reg[4]  = low_addr;
    cfg_reg[5]  = 0x00;
    cfg_reg[6]  = 0x60 | 0x02;             // 9600 baud + 2400 air speed
    cfg_reg[7]  = 0x00 | 0x00 | 0x20;      // 240B pkt + 22dBm + noise RSSI
    cfg_reg[8]  = s_channel_offset;        // 15 for 865 MHz
    cfg_reg[9]  = 0x40 | 0x03 | rssi_flag; // Fixed mode + WOR 2000ms + packet RSSI
    cfg_reg[10] = 0x00;
    cfg_reg[11] = 0x00;
